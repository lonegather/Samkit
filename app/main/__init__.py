...
def reset():
    ...
    for data in [
        {'project':prj, 'genus':gns_batch, 'name':u'scp', 'info':u'剧本', 'path':u'{project}/{stage}/{entity}/'},
        {'project':prj, 'genus':gns_batch, 'name':u'stb', 'info':u'分镜', 'path':u'{project}/{stage}/{entity}/'},
        {'project':prj, 'genus':gns_batch, 'name':u'dub', 'info':u'配音', 'path':u'{project}/{stage}/{entity}/'},
        {'project':prj, 'genus':gns_asset, 'name':u'dsn', 'info':u'原画', 'path':u'{project}/{genus}/{tag}/{entity}/{stage}/'},
        {'project':prj, 'genus':gns_asset, 'name':u'mdl', 'info':u'建模', 'path':u'{project}/{genus}/{tag}/{entity}/{entity}_{stage}.ma'},
        {'project':prj, 'genus':gns_asset, 'name':u'txt', 'info':u'贴图', 'path':u'{project}/{genus}/{tag}/{entity}/{stage}/'},
        {'project':prj, 'genus':gns_asset, 'name':u'shd', 'info':u'材质', 'path':u'{project}/{genus}/{tag}/{entity}/{stage}/'},
        {'project':prj, 'genus':gns_asset, 'name':u'skn', 'info':u'蒙皮', 'path':u'{project}/{genus}/{tag}/{entity}/{entity}_{stage}.ma'},
        {'project':prj, 'genus':gns_asset, 'name':u'rig', 'info':u'绑定', 'path':u'{project}/{genus}/{tag}/{entity}/{entity}_{stage}.ma'},
        {'project':prj, 'genus':gns_asset, 'name':u'prv', 'info':u'预览', 'path':u'{project}/{genus}/{tag}/{entity}/{stage}/'},
        {'project':prj, 'genus':gns_shot,  'name':u'lyt', 'info':u'布局', 'path':u'{project}/{genus}/{stage}/{project}_{tag}_{entity}.ma'},
        {'project':prj, 'genus':gns_shot,  'name':u'anm', 'info':u'动画', 'path':u'{project}/{genus}/{stage}/{project}_{tag}_{entity}.ma'},
        {'project':prj, 'genus':gns_shot,  'name':u'cfx', 'info':u'解算', 'path':u'{project}/{genus}/{stage}/{project}_{tag}_{entity}.ma'},
        {'project':prj, 'genus':gns_shot,  'name':u'lgt', 'info':u'灯光', 'path':u'{project}/{genus}/{stage}/{project}_{tag}_{entity}/'},
        {'project':prj, 'genus':gns_shot,  'name':u'rnd', 'info':u'渲染', 'path':u'{project}/{genus}/{stage}/{project}_{tag}_{entity}/'},
        {'project':prj, 'genus':gns_shot,  'name':u'vfx', 'info':u'特效', 'path':u'{project}/{genus}/{stage}/{project}_{tag}_{entity}/'},
        {'project':prj, 'genus':gns_shot,  'name':u'cmp', 'info':u'合成', 'path':u'{project}/{genus}/{stage}/{project}_{tag}_{entity}/'},
